"""
Document processor module for the Hierarchical RAG system.
Handles loading, processing, and hierarchical chunking of documents.
"""
import os
import logging
...
class HierarchicalDocumentProcessor:
    """Class for processing documents with hierarchical chunking."""
    
    def __init__(self, kb_path: str = KB_PATH):
        """
        Initialize the hierarchical document processor.
        ...
        # Text splitter for leaf nodes (smaller chunks)
        ...
        # Text splitter for root/parent nodes (larger chunks)
    ...
    def create_hierarchical_chunks(self, documents: List[Dict[str, Any]]) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
        """
        ...
        Returns:
            Tuple of (root_chunks, leaf_chunks) where each is a list of chunk dictionaries
        """
        if not documents:
    ...
    def generate_summaries_for_root_chunks(self, root_chunks: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        Args:
            root_chunks: List of root chunk dictionaries
            
        Returns:
            List of root chunks with summaries added
        """
        if not root_chunks:
            return []
    ...
    def process_documents(self) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
        """
        Load and process documents from the knowledge base with hierarchical chunking.
        
        Returns:
            Tuple of (root_chunks, leaf_chunks) where each is a list of processed chunk dictionaries
        """
        # Load documents
